...
public class NetworkExecutorTest {
  ...
  @Test(expected=IllegalStateException.class) public void serviceExecutorInstanceBuilderTest1() throws Exception {
     new RetrofitApiServiceExcecutor.Builder()
        .errorConverter(null)
        .retryOnErrorPolicy(null).build();
  }

  @Test(expected=IllegalStateException.class) public void serviceExecutorInstanceBuilderTest2() throws Exception {
