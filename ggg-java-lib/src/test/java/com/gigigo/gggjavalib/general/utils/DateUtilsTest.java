...
public class DateUtilsTest {
    ...
    public void testDateToStringWithFormatOk() throws Exception {
        ...
        String expectedDate = DateUtils.dateToStringWithFormat(date, DateFormatConstants.DATE_FORMAT_TIME);

        assertEquals("2013-09-29T18:46:19Z", expectedDate);
    }

    @Test
    public void testDateToStringWithFormatNoTimeOk() throws Exception {
        Date date = getCalendar(2013, Calendar.SEPTEMBER, 29, 18, 46, 19);

        String expectedDate = DateUtils.dateToStringWithFormat(date, DateFormatConstants.DATE_FORMAT_NO_TIME);

        assertEquals("2013-09-29", expectedDate);
    }

    @Test
    public void testStringToDateWithFormatNoTimeGoodDate() throws Exception {
        String stringDate = "2013-09-29";

        Date date = DateUtils.stringToDateWithFormat(stringDate, DateFormatConstants.DATE_FORMAT_NO_TIME);
